import { verifyMechanicRecord } from './src/utils/dataVerificationAgent';
...
const sampleRecords = [
  ...
  {
    id: 3,
    businessName: "PQR Parts Store",
    mechanicType: "Authorized Service Center",
    status: "Approved",
    phone: "+919876543212",
    address: "789 Shopping Mall, Bangalore",
    vehicleTypes: ["Car"],
    serviceTypes: [],
    categories: ["Auto Parts Store", "Car Accessories"],
    description: "Official parts store for all car brands",
    latitude: "12.9716",
    longitude: "77.5946"
  }
];
